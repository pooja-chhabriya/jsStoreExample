...
// import JsStoreDemo from './views/Program/JsStoreDemo';
...
const JSStore = React.lazy(() => import('../src/views/Program/JsStoreDemo'));
...
const routes = [
  ...
  { path: '/program/jsstoredemo', name: 'JsStoreDemo', component: JSStore, exact: true }
];
